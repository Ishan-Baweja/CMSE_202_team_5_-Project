...
- Ishan Baweja: Setup the Repositroy and Google Slides, created several Presentation Slides, Imported all Data sets, creaetd prediction model for the first dataset adn assisted in coding for regression models
